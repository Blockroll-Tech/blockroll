...
const Card = () => {
  return (
    <div className='grid md:grid-cols-2 gap-20 border-solid p-8'>
      <div className='md:text-left order-1'>
      ...
      <div className='md:text-left h-90 order-3'>
      ...
      <div className='md:text-left h-96 order-5'>
        <h1 className='mt-8 font-bold text-lg pb-[10px]'>Sign up for free to enjoy</h1>
      ...
      <div className='md:text-left h-96 order-7'>
