      ...
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-6 lg:py-12 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            ...
            <a rel="noopener noreferrer" href="https://form.typeform.com/to/hnHvhN7C" className="px-8 py-3 text-lg font-semibold border rounded dark:border-gray-100">Join Waitlist</a>
          </div>
        </div>
