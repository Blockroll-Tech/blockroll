  ...
  return (
    <section className="bg-white">
      ...
      <div className="container flex flex-col justify-center pt-2 mx-auto sm:py-6 lg:py-12 lg:flex-row lg:justify-between text-left">
        ...
        <div className="grid grid-cols-2 items-center p-6 md:hidden md:order-2 gap-10 space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
